...
class RefreshStockProfileCommandTest extends DatabaseDependantTestCase
{
    ...
    public function the_refresh_stock_profile_command_behaves_correctly_when_a_stock_record_does_not_exist()
    {
        ...
        FakeYahooFinanceApiClient::$content = '{"symbol":"AMZN","shortName":"Amazon.com, Inc.","region":"US","exchangeName":"NasdaqGS","currency":"USD","price":325871,"previousClose":317269,"priceChange":8602}';
        ...
        $this->assertGreaterThan(5000, $stock->getPreviousClose());
        $this->assertGreaterThan(5000, $stock->getPrice());
